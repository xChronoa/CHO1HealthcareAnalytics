...
export default function Appointment() {
    return (
        <>
            ...
            <main className="flex flex-col items-center justify-center min-h-screen bg-almond">
                ...
                <div className="flex flex-col items-center justify-center w-4/5 appointment-details">
                    <h2 className="self-center my-5 text-lg font-bold uppercase md:self-start">Personal Information</h2>
                    
                    <form id="appointment" className="flex flex-col justify-center w-3/4 p-5 px-8 mt-2 mb-16 border-2 border-black rounded min-w-96">
                        {/* Full Name */}
                        ...
                        <div className="flex flex-col mb-3 input-group">
                            ...
                            <div className="relative w-full input">
                                ...
                                <button className="absolute p-1 px-3 text-white transition-all rounded-full shadow-xl right-2 top-1 bg-green hover:opacity-75">Send OTP</button>
                            </div>
                        </div>
                        ...
                        <button className="p-2 my-5 font-bold text-white uppercase transition-all rounded-lg shadow-xl bg-green hover:opacity-75" type="submit">Submit</button>
                    </form>
                </div>
            </main>
