...
const Overview: React.FC = () => {
    return (
        <>
            <section
                id="appointment"
                className="flex flex-col items-center justify-center flex-1 w-full px-4 py-4 text-sm sm:text-base sm:px-12"
            >
                <div className="container flex flex-col w-full gap-12 md:flex-row">
                    <div className="flex flex-col self-center flex-1 gap-4 text-base lg:px-0 md:justify-between left md:text-lg">
                        <h1 className="text-lg font-bold text-center md:text-left lg:text-2xl">
                        ...
                        <Link
                            to={"/appointment"}
                            className="self-center sm:self-baseline mt-6 lg:mt-8 lg:text-xl transition-all text-[.7rem] sm:text-sm text-black inline-flex items-center bg-white border border-black hover:text-white hover:bg-[#009900] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-fit shadow-md shadow-gray-500"
                        >
                            Make an Appointment
                        </Link>
                    </div>
            ...
            <section
                id="about-us"
                className="flex flex-col items-center justify-center flex-1 w-full px-4 py-4 text-sm sm:text-base sm:px-12 bg-green "
            >
                <div className="container wrap">
                    ...
                    <div className="flex flex-col gap-16 text-justify lg:gap-8 lg:flex-row">
            ...
            <section
                id="programs-events"
                className="flex flex-col items-center justify-center flex-1 w-full px-4 py-12 bg-gray-200 sm:px-8"
            >
                <div className="container flex flex-col items-center justify-center flex-1 w-full wrap">
                    <div className="flex flex-row items-center w-full gap-4 md:px-8 title">
                        <h1 className="text-xl font-bold text-black uppercase text-nowrap">
                            Programs & Events
                        </h1>
                        <div className="flex-1 h-[2px] border-black border-[1px]" />
                    </div>
                    <div className="grid items-center justify-center w-full grid-cols-1 gap-8 pt-2 pb-4 md:px-8 sm:grid-cols-2 place-items-center justify-items-center wrap">
                        <img
                            src={breast_cancer}
                            alt="Breast Cancer"
