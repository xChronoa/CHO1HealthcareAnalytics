            ...
            {error ? (
                ...
                modernWRAReports !== null ? (
                    <>
                        ...
                        <div id="printableTable" className="relative flex flex-col w-full gap-6 py-12 overflow-x-auto border-2 border-black rounded-lg xl:items-center 2xl:items-center 2xl:justify-center">
                            <h1 className="text-nowrap text-gray-300 absolute top-0 right-0 m-2 rotate-180 text-lg" style={{ writingMode: 'vertical-rl' }}>M1 Template 2024</h1>
                            <table
                                id="header"
