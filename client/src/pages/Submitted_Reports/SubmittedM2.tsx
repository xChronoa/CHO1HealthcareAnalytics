                                    ...
                                    <tr>
                                        ...
                                        <td colSpan={35} className="border border-black">
                                            <section className="relative flex flex-col items-center justify-center gap-2">
                                                ...
                                                <h1 className="text-nowrap text-gray-300 absolute top-0 right-0 m-2 text-lg">M2 Template 2024</h1>
                                            </section>
                                        </td>
                                        <th
                                            colSpan={4}
