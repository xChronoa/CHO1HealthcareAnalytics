        ...
        <div className="w-11/12 py-16">
            ...
            <section className="flex flex-col items-start">
                <div className="flex flex-col items-center justify-between w-full gap-6 mb-6 md:gap-0 md:flex-row filter">
                    ...
                    {/* Tabs */}
                    <div className="flex flex-row items-center justify-center gap-5">
                        <button className="w-24 py-2 text-white bg-green" type="button">All</button>
                        <button className="w-24 py-2 text-white bg-green" type="button">Pending</button>
                        <button className="w-24 py-2 text-white bg-green" type="button">Received</button>
                    </div>
                </div>
                <div className="w-full table-container">
                    <table className="w-full text-center">
                        ...
                        <tbody>
                            {/* Dummy Data */}
                            <tr>
                                <td className="px-4 py-2 font-semibold uppercase">Bigaa</td>
                                <td className="px-4 py-2 font-semibold uppercase">March 08, 2024</td>
                                <td className="px-4 py-2 font-semibold text-red-600 uppercase">Pending</td>
                            </tr>
                            <tr>
                                <td className="px-4 py-2 font-semibold uppercase">Bigaa</td>
                                <td className="px-4 py-2 font-semibold uppercase">March 08, 2024</td>
