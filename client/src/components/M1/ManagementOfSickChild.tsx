...
export const ManagementOfSickChild: React.FC<ServiceProps> = ({
    formData,
    updateServiceData
}) => {
    const {
    ...
    useEffectAfterMount(() => {
        fetchIndicatorsByServiceName("Management of Sick Infants and Children");
    }, []);
        ...
        <>
            <fieldset className="w-11/12 p-4 border border-black rounded-md sm:w-fit">
                ...
                <div className="flex flex-col gap-4">
                    {indicatorLoading ? (
                        <div>
                            Loading management of sick infants and children...
                        </div>
                    ) : error ? (
                        <div>
                            Error: {error}
